...
<body class="builderUI">
        ...
        <div class="menu" id="menu">
            ...
            <div class="main" id="main">
                ...
                <ul id="templatesUl" style="margin-bottom: 30px">
                    <li><a href="#" id="templ"><?php echo $this->lang->line('choose_template');?></a></li>
                </ul>
                <?php endif;?>
            ...
            <header class="clearfix affix">
                ...
                <div class="btn-group" style="float: right;">           
                    <button class="btn btn-primary" id="savePage">
                        ...
                        <span class="bLabel"><?php echo $this->lang->line('actionbuttons_save')?></span>
                    </button>
                ...
                <?php else:?>
                <a href="#" id="savePage" data-toggle="modal" class="btn btn-primary btn-embossed pull-right actionButtons">
                    <span class="fui-check"></span>
                    <span class="bLabel"><?php echo $this->lang->line('actionbuttons_save')?></span></a>
                <?php endif;?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <span class="publishing">
                                                        <span class="working"><?php echo $this->lang->line('modalpublish_publishing')?> <img src="<?php echo base_url();?>images/publishLoader.gif"></span>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <?php 
                        ...
                        if( isset($pagesData) ) {
                            echo $this->load->view('partials/pagedata.php', array('pagesData'=>$pagesData, 'siteData'=>$siteData['site']), true);
                        } else {
                            echo $this->load->view('partials/pagedata.php', array('siteData'=>$siteData['site']), true);
                        }
    ...
    <div class="modal fade" id="previewModal" tabindex="-1" role="dialog" aria-hidden="true">
        ...
        <form action="<?php echo site_url('/sites/livepreview');?>/" target="_blank" id="markupPreviewForm" method="post" class="form-horizontal">
    ...
    <div class="modal fade" id="delTemplateModal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default btn-embossed" data-dismiss="modal"><span class="fui-cross"></span> <?php echo $this->lang->line('modal_cancelclose')?></button>
                    <a href="<?php echo site_url('sites/deltempl/'.$siteData['site']->sites_id)?>" class="btn btn-primary btn-embossed" id="templateDelButton"><span class="fui-check"></span> <?php echo $this->lang->line('modal_deltemplate_button')?></a>
                </div>
  ...
  <script src="<?php echo base_url('js/vendor/spectrum.js');?>"></script>
